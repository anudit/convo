...
export async function createComment(data, noBroadcast=null) {
    ...
    publishToChannels({_id:newId[0], action: "createComment", ...data}, noBroadcast);
    return newId[0];
...
export async function updateComment(data) {
    ...
    publishToWss({action: "updateComment", ...data});
    return resp;
...
export async function deleteComment(id) {
    ...
    if(isValid === true ){
        ...
        publishToWss({action: "deleteComment", id: id});
        return true;
    }
    else{
        return false;
