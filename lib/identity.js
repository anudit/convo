...
export async function getProjectGalaxyData(address) {
...
export async function getAge(address){
    let etherscanReq = fetch(`https://api.etherscan.io/api?module=account&action=txlist&address=${address}&startblock=0&endblock=99999999&page=1&offset=10&sort=asc&apikey=U1XY38A3E61KRFG2DEM8JQJ1XPCNFRZ79R`).then(r=>{return r.json()});
    let polygonscanReq = fetch(`https://api.polygonscan.com/api?module=account&action=txlist&address=${address}&startblock=0&endblock=99999999&page=1&offset=10&sort=asc&apikey=ZU4PIWRH1C1VDPVMIBW3R5EV1KA8GJANVY`).then(r=>{return r.json()});
...
export async function getArcxData(){
...
export async function getContextData(address){
...
export async function getRabbitholeData(address = ""){
...
export async function getBoardroomData(address) {
...
export async function getMetagameData(address) {
...
export async function getCoordinapeData(address) {
    try {
        ...
        let response = await fetch(`https://coordinape.com/api/profile/${address}`, {
            "headers": {
            "accept": "*/*",
            "content-type": "application/json",
            },
